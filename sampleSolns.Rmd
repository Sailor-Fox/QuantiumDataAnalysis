...
```{r Further examine PROD_NAME, eval = FALSE}
...
```{r Clean brand names, eval = FALSE}
#### Clean brand names
...
```{r 1 Exploratory data analysis, eval = FALSE}
#### Examining customer data
